...
function getAllSamples() {
  return superagent.get(
    `http://admin:${password}@${host}/${db}/_design/app/_view/entryByKind?key="sample"&reduce=false&include_docs=true`,
  );
}

function getAllReactions() {
  return superagent.get(
    `http://admin:${password}@${host}/${db}/_design/app/_view/entryByKind?key="reaction"&reduce=false&include_docs=true`,
  );
}
...
function updateSample(entry) {
  ...
  return superagent
    .put(`http://admin:${password}@${host}/${db}/${entry._id}`)
